...
def Download_the_one():
    format_image_id = input("please input which image you need! (a number is required)")
...
argument =input("What can I do for you?(CASE INTENSIVE) A: Show me the latest comic image! B: Show me the comic image I prefer! C: How many comic images exist here?")
